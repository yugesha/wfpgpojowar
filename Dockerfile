...
RUN ["/bin/mv","/opt/wildfly-9.0.1.Final/standalone/configuration/standalone.xml", "/opt/wildfly-9.0.1.Final/standalone/configuration/standalone.xml_backup]
# RUN rm -rf /opt/wildfly-9.0.1.Final/standalone/configuration/standalone-full.xml_backup
RUN ["/bin/mv","/opt/wildfly-9.0.1.Final/standalone/configuration/standalone-full.xml", "/opt/wildfly-9.0.1.Final/standalone/configuration/standalone-full.xml_backup"]
...
RUN ["/bin/chmod","555","/home/startservers.sh"]
...
VOLUME ["/var/lib/postgresql/9.4/main", "/etc/postgresql/9.4/main"]
