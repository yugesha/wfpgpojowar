...
COPY Deployment/InitW1/TestInstallation/dependencies/jboss-logging-3.3.0.Final.jar /opt/wildfly-9.0.1.Final/standalone/lib/ext
COPY Deployment/InitW1/TestInstallation/dependencies/module_ForJBossLogging.xml /opt/wildfly-9.0.1.Final/standalone/lib/ext
...
COPY Deployment/InitW1/TestInstallation/dependencies/xstream-1.0.1.jar /opt/wildfly-9.0.1.Final/standalone/lib/ext
COPY Deployment/InitW1/TestInstallation/dependencies/xstream-1.2.jar /opt/wildfly-9.0.1.Final/standalone/lib/ext
